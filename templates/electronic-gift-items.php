...
/**
 * Template Name: Electronic Gift Items
 */
get_header();
    ...
    <div id="gifting-section" class="large__block container__fluid__wrap spacing__50">
        <div class="gallery">
            ...
            <div class="items__wrapp">
                ...
                // Define the taxonomy and the term slug for electronics page
                $taxonomy = 'product_cat';
                $required_term = 'electronics-gift-item';
                ...
                foreach ($membership_tiers as $tier) {
                    ...
                    if (!empty($product_ids) && is_array($product_ids)) {
                        ...
                        $filtered_ids = array_filter($product_ids, function ($pid) use ($required_term, $taxonomy) {
                            return has_term($required_term, $taxonomy, $pid);
                        });
         ...
         <div class="modal-dialog modal__dialog">
            <div class="modal-content modal__content">
               <div class="modal-body modal__body">
                  <h4>Congratulations! Your Sigma BF Camera Pre-Booking is Almost Complete!</h4>
                  <p>You’ve successfully reserved your Sigma BF Camera. Complete the final step below to confirm your pre-booking.</p>
                  <div class="form__wrapp">
                     <form>
                        ...
                        <div class="form-group form__group">
                           <label>Email*</label>
                           <input type="email" class="form-control form__control" />
                        </div>
                        <div class="form-group form__group">
                        ...
                        <div class="form-group form__group">
                           <label>Genre of occupation</label>
                           <input type="text" class="form-control form__control" />
                        </div>
                        <button class="submit__btn" type="submit">Complete Pre-Booking</button>
                     </form>
                  </div>
               </div>
            </div>
