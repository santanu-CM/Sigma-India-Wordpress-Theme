	...
	?>
		...
		<?php else : ?>
			...
			foreach ($order->get_items() as $item) {
				$points = (int) $item->get_meta('online_purchase_points');
				$qty = $item->get_quantity();
				$total_earned_points += ($points * $qty);
			}

			if ($total_earned_points > 0) :
			?>
				<div class="alert alert-success mt-4 spacing__bottom__40" role="alert">
					<strong>Congratulations!</strong> You have earned <strong><?php echo $total_earned_points; ?></strong> points for this order.<br>
					These will be credited to your account after purchase complete.
				</div>
			<?php endif; ?>
