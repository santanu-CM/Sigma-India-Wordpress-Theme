<?php
$events_page_field_content= get_field('events_page_field_content');
?>
<div class="main__banner inner__banner__main inner__banner__small inner__banner__small__left__align">
     <?php if(!empty($events_page_field_content['banner_image'])):?>
    <div class="image__box">
        <img src="<?php echo $events_page_field_content['banner_image'];?>" alt="" />
    </div>
    <?php endif;?>
    <div class="bannre__content">
        <div class="container">
            <div class="bannre__content__inner__wrapp">
                <h1><?php the_title();?></h1>
                <?php echo apply_filters('the_content', $events_page_field_content['banner_content']);?>
