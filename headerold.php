...
?>
<!-- <button type="button" class="btn btn-secondary btn-lg btn-floating" id="btn-back-to-top" aria-label="Back to top">
    ...
    <nav class="navbar navbar-expand-lg navbar__top js--sticky-nav">
        <div class="container">
            ...
            <div class="nav__info__right">
                ...
                <a
                    href="<?php echo (!empty($header_top_content['my_account_url'])) ? $header_top_content['my_account_url']:'#';?>">
